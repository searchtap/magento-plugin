    ...
    protected function _prepareForm()
    {
        ...
        if (!$token) {
            ...
            $searchtapDashboard->addField('link', 'link', array(
                'after_element_html' => '<a href="https://magento.searchtap.io/signup" target="_blank" class="action-default primary" style="background-color: #e85d22;color: white;font-weight: 500;padding-bottom: 0.6875em; padding-top: 0.6875em;">
